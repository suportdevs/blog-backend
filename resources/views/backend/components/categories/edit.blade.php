            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="card-title mb-0">
                                    <i class="mdi mdi-sitemap"></i> Categories <small class="text-muted">Edit</small>
                                </h4>
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <form class="form" method="POST" action="{{ route('admin.categories.update',[$category->id, $category->slug]) }}">
                                    @csrf
                                    <div class="row justify-content-center">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="name">Name</label> <span class="text-danger">*</span>
                                                <input class="form-control" type="text" name="category_name" id="name" placeholder="Name" value="{{ $category->category_name }}" require="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="name">Slug</label> <span class="text-danger">*</span>
                                                <input class="form-control" type="text" name="slug" id="slug" placeholder="Slug" value="{{ $category->slug }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" placeholder="Description" value="{{ $category->description }}">{{ $category->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
